...
namespace PersonPicture.Service
{
    public class PersonService : IPersonService
    {
        ...
        private async Task<Person> GetUser()
        {
            ...
            var user = await _context.DbPeoples.FirstOrDefaultAsync(u => u.Id == userId);
            return user;
        }
        ...
        public async Task AddPicture(FileUpload picture)
        {
